...
// 4. 인터페이스는 멤버메소드로 public abstract 메소드만 가질 수 있습니다.
// 5. 추상클래스보다도 더 상속을 위해서 만들어진 클래스 입니다.
// 6. 다중 상속이 가능합니다
...
interface InterA{
	...
	// fianal 변수는 생성시에 반드시 초기값이 있어야 그값으로 고정됩니다
	
	// InterA(){}  // 에러 - 생성자를 갖을 수 없습니다
	// public void print() {}  // 에러 - 일반 메서드를 생성하지 못합니다
...
public class Interface01 {
	...
	public static void main(String[] args) {
		// InterA a = new InterA(); 에러 - 생성자가 없어서 객체를 만들수 없습니다.
		// 추상클래에는 생성자가 존재합니다. 그러나 추상메서드때문에 객체생성은 안됩니다.
