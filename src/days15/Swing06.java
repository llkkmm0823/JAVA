...
class JFlowLayout extends JFrame{
	...
	JFlowLayout(){
		/* 배치관리자 없이 버튼을 컨테이너에 무작정 올린형대 (FlowLayout도 적용안된 상태)
