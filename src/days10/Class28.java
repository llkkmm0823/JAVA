...
class StaticD{
	//private 으로 지정된 static 멤버는 클래스의 내부에서만 사용이 가능한 멤버
	private static int count;
	// private을 지정된 static 변수를 이용(접근)하고자 한다면,
	...
	//인스턴스 메서드에서도 접근은 가능하지만 객체 생성 후 이용이 가능
...
public class Class28 {
	...
	public static void main(String[] args) {
		// private으로 감춰진 static 멤버변수는 클래스 외부에서 접근이 차단됨
		// StaticD.count = 50; // 에러
		StaticD.setCount(15);
