...
public class Collection05 {
	...
	public static void main(String[] args) {
		...
		// 두 개의 데이터가 같은 키값을 갖고 있을 수는 없음
		// 중복되지 않은 키 값으로 데이터를 추가
		ht.put("Four",4); ht.put("Five",5);
		hm.put(4, "Four"); hm.put(5, "Five");
		System.out.printf("중복되지 않은 키 값으로 추가 후 ht.size()->%d\n",ht.size());
		System.out.printf("중복되지 않은 키 값으로 추가 후 hm.size()->%d\n",hm.size());

		//Value 값이 중복되게 데이터 추가
		ht.put("Six",1);		ht.put("Seven",2);
		hm.put(6, "One"); hm.put(5, "Two");
		System.out.println("\n중복된 value값으로 데이터 추가 후 : ");
		...
		System.out.println();
// 동일한 키 값으로 다른 Value가 입력되는 경우 기존의 Value값이 수정됨
