...
public class Formatter02 {
	...
	public static void main(String[] args) {
		...
		number =123456789.0;
		//천 단위 구분 기호 표시 패턴 0,000,000
		df = new DecimalFormat("0,000");// 콤마(,) 찍어주기
		System.out.printf("%19s : %f  -> %s\n", "0,000",number,df.format(number));
