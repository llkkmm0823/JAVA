...
public class Print02 {
	...
	public static void main(String[] args) {
		...
		// 키보드가 허락하는 한 어떤 내용이든 구성하여 출력할 수 있습니다.( 잘못된 정보라도 출력가능 )
		...
		// 그리고 그 자리에 출력될 내용은 ""가 끝난 후 뒤에 콤마( , )로구분하고 써서 매칭되도록 합니다.
		System.out.printf("56 x 69 = %d\n", 1234);
		// 자바에서 문자형 자료는 "" 안에 쓰여지고 따옴표 없이 사용되는 자료들은 정수, 실수 들로 인식합니다.
		
		System.out.printf("56 x 69 = %d\n", 56*69);
		// 컴퓨터 내에서 곱셈은 *로 표기.  간단한 연산은 컴퓨터에 시키고, 그 결과를 내가 출력하려는 구문에 끼워서 출력할 수 있습니다.
		System.out.printf("56.5 x 69.3 = %f\n", 56.5*69.3);
		System.out.printf("56 x 69 = %s\n", "삼천팔백육십사");
		//연산이 아닌 문자열을 끼워 출력할 때에는 ""내에 기입하기

		// % 이스케이프 문자는 갯수에 상관없이 필요한 만큼 여러 개 구성하여 사용이 가능합니다.
		System.out.printf("%d x %d = %d\n", 23 , 87, 23*87);
		// " " 안의 % 갯수와 순서대로 출력될 데이터를 콤마( , )로 구분하여 나열하면 순서대로 매칭 출력됩니다.
		// 소수점이 있는 실수의 출력
		...
		//System.out.printf("%d\n",23.45);  // 에러_ 정수형이나 소수점있음
		//System.out.printf("%f\n",23);  // 에러_실수형이나 정수임

		// 소수점을 조절하여 출력하려면 아래와 같이 씁니다.
		System.out.printf("%d ÷ %d = %.2f\n",27,13,27/13.0);
		// 소수점 조절에 의해(%와 f 사이에 .원하는 자릿수 기입) 자리수가 조절되고, 없어지는 곳은 반올림 됩니다. 
		// ▲위는 소수점 셋째자리에서 반올림되어 둘째자리까지만 출력되는 것을 볼 수 있음.
