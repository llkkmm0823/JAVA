...
public class controlop_QuestionMark {
	...
	public static void main(String[] args) {
		...
		// 괄호안의 비교연산이 true이면 콜론 왼쪽의 "합격"이, false 이면 콜론 오른쪽의 "불합격"이 prnText에 저장
		System.out.println("입력한 점수는 " + prnText + "입니다");
		//심심치 않게 등장한단다
		
		System.out.printf("기본급을 입력하세요 : ");
		int a = sc.nextInt();
		//기본급 100만원 이상이면 50%, 100만원 미만이면 60% 가산하여 지급액 출력
		...
		//코드#2
		double b = (a>=1000000)?a+a*0.5 :a+a*0.6 ; //콜론 양 옆에 연산식 작성도 가능
